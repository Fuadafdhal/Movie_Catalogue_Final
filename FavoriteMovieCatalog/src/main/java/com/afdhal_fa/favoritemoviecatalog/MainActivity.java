...
import com.afdhal_fa.favoritemoviecatalog.adapter.MovieAdapterFavorite;
...
import com.afdhal_fa.favoritemoviecatalog.helper.MappingHelper;
...
public class MainActivity extends AppCompatActivity implements LoadMoviesCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MainActivity.DataObserver myObserver = new MainActivity.DataObserver(handler, this);
        getContentResolver().registerContentObserver(DatabaseContract.MovieColumns.CONTENT_URI, true, myObserver);

        if (savedInstanceState == null) {
            new MainActivity.LoadMovieAsync(this, this).execute();
        } else {
...
/*
 ...
 /*
        ...
        if (movies.size() > 0) {
            ...
            adapter.setListMovies(new ArrayList<MovieData>());
    ...
    public static class DataObserver extends ContentObserver {
        ...
        public void onChange(boolean selfChange) {
            ...
            new MainActivity.LoadMovieAsync (context, (LoadMoviesCallback) context).execute();
        }
    }
}
